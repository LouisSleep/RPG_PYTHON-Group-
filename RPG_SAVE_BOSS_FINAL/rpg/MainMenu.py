...
def create_game():
    ...
    while i < 10000:
        ...
        if word_Yes_No[0] == choice_lower:
            print()
            delay_print("\n""Vous voici dans une nouvelle sauvegarde :")
            print()
            print()
            name = input(delay_print("\n""Choissisez un pseudo : "))
            print()

            delay_print("\n""Votre partie va se lancer {}".format(name))
            time.sleep(3)
        ...
        if choice == setting_choice[0]:
            delay_print("""
                1 - Régles du jeux
                        ...
                        Les règles sont simples. Giovanni vous donne l'importante Mission de voler tous les pokémon de la région pour son plaisir personnel. 
                        Arriverez-vous à accomplir cette mission et a vaincre votre ennemi juré ?
                        
                        Ps: Le Racket est autorisé..
            ...
            delay_print("""
                2 - Crédits
                        Ce superbe jeu a été développé par Billy , Anthony , Ewan et Louis ! 
...
╚═╝      ╚════╝ ╚═╝  ╚═╝╚══════╝    ╚═╝  ╚═╝╚═╝  ╚═╝ ╚════╝ ╚═╝  ╚═╝╚══════╝   ╚═╝''', stop,"\n")
        ...
        if choice == choice_game_list[0]:
            ...
            while game == True:
                ...
                bank_account = 10000  # Compte en banque
